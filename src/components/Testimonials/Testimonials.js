      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="flex justify-between mt-20 italic lg:text-base  text-sm gap-6 sm:flex-row flex-col">
          ...
          <div className="font-extrabold text-6xl -mb-8">"</div>
            <p>
              "Everyday Harvest is just awesome! I just launched a startup which leaves me
              with no time for cooking, so Everyday Harvest is a life-saver. Now that I
              got used to it, I couldn't live without my daily healthy meals!
            </p>
          ...
          <div className="sm:max-w-xs">
            ...
            <p>
              ...
              my home. We have lots of food delivery here in faridabad, but no one
              comes even close to Everday Harvest. Me and my family are so in love!
            </p>
            <div className="flex items-center sm:mt-8 mt-4 gap-2">
              <div>
                <Image
          ...
          <div className="sm:max-w-xs">
           <div className="font-extrabold text-6xl -mb-8">"</div>
            <p>
              I was looking for a quick , healthy and easy food delivery service in faridabad. I tried a lot of them and ended up with Omnifood. Best
